...
class RoleSeeder extends Seeder
{
    ...
    {
        #Roles for users from Spatie
        #The roles are associated with permissions
        $role_admin = Role::create(['name' => 'admin']);
        $role_editor = Role::create(['name' => 'editor']); #Does not have all the permissions

        #Permissions for users from Spatie
        ...
        $role_admin -> syncPermissions($permissions_admin); #syncPermissions is from spatie
        $role_editor -> syncPermissions($permissions_editor); #if we are assigning only one permission the method is givePermissionTo()
